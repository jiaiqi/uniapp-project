				...
				>
					...
					<view class="smallbox">
						<view class="smallbox-img">
							<u-image width="100%" height="100%" v-if="!food.imgurl" src="/static/img/none.png"></u-image>
				...
				<view class="content">
					...
					<view class="calculate">
						...
						<view class="weight">
							...
							<!-- <image @click="changeUnit(currFood)" src="../../../../static/img/change.png" mode=""></image> -->
							<!-- </view> -->
							<!-- 300
	...
	methods: {
		...
		chooseMenu(parent,child){
			...
			if(parent.type === 'vitamin' || parent.type === 'mineral' ||parent.type === 'mingle'){
				...
				let arr = ['vitamin','mineral','mingle']
				let hasChild = false
				menuData.forEach(par=>{
					if(par.type === parent.type){
						par.children.forEach(p=>{
