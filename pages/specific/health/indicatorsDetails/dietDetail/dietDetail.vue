	...
	export default{
		data(){
			return{
				...
				dataItem:[
					{
						img:require('@/static/img/indiDetailImg/t2Detail.png'),
						title:'身高体重指标',
						number:'24.5',
						icon:require('@/static/img/indiDetailImg/failDetail.png'),
						units:''
					},
					{
						img:require('@/static/img/indiDetailImg/t1Detail.png'),
						title:'建议体重',
						number:'65.08',
						icon:'',
						units:'公斤'
