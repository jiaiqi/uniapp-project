		...
		<view class="container-cen">
			<view class="container-cen-top">
				<view class="container-cen-top-list" @click="toPages('yundong')">
					<image src="/static/img/yd.png" mode=""></image>
					<text>运动</text>
				</view>
				<view class="container-cen-top-list">
					<image src="/static/img/sm.png" mode=""></image>
					<text>睡眠</text>
				</view>
				<view class="container-cen-top-list" @click="toPages('pinggu')">
					<image src="/static/img/pg.png" mode=""></image>
					<text>评估</text>
				</view>
			</view>
			<view class="container-bot">
				<view class="cu-list menu sm-border">
					<view @click="toPersonDetail('person')" class="cu-item arrow">
						<view class="content">
							<image src="/static/img/zl.png" mode=""></image>
							<text class="text-grey">基本信息</text>
						</view>
					</view>
					<view @click="toPersonDetail('corp')" class="cu-item arrow">
						<view class="content">
							<image src="/static/img/st.png" mode=""></image>
							<text class="text-grey">身体数据</text>
						</view>
					</view>
					<view class="cu-item arrow">
						<view class="content">
							<image src="/static/img/pgs.png" mode=""></image>
	...
	methods: {
		toPages(e) {
			switch (e) {
				case 'pinggu':
					uni.navigateTo({
						url: '/pages/specific/health/healthQuestionnaire/healthQuestionnaire'
					});
					break;
				case 'yundong':
					uni.navigateTo({
		...
		toPersonDetail(type) {
			uni.navigateTo({
				url: '/pages/specific/health/personalDetail/personalDetail?type=' + type
			});
		}
	},
	created() {
