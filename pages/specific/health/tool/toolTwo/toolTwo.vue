<template>
	<view class="wrap">
		<view class="cu-form-group ">
			...
			<input placeholder="请输入你的体重" v-model="info.weight" @blur="change()" name="input"></input>
		</view>
		<view class="cu-form-group ">
			<view class="title">身高(cm)</view>
			<input placeholder="请输入你的身高" v-model="info.age" @blur="change()" name="input"></input>
		</view>
		<view class="cu-form-group ">
			<view class="title">年龄</view>
			<input placeholder="请输入你的年龄" v-model="info.newAge" @blur="change()" name="input"></input>
		</view>
		<view class="cu-form-group">
			<view class="title">性别</view>
			<input placeholder="请选择你的性别" @click="show = true"  v-model="info.sex" name="input"></input>
		</view>
		<view class="boxbtn">
		...
		<view class="contents">
						...
						<view class="ele-item-wrap">
							<view class="padding bg-white probar">
								<view class="cu-progress radius pro-rad">
									...
									<view :class="statusStyle(BMI)" class="tootio-item-wrap">
			...
			<view class="" v-if="metabolism">
				...
				<view class="nubox">
					...
					<text style="">千卡</text>
					<!-- <image src="https://helloyishi.com.tw/wp-content/themes/hb-2015/images/icon-burn.png" mode=""></image> -->
				</view>
			</view>
		</view>
	</view>
